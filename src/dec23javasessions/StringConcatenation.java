...
public class StringConcatenation {
	...
	public static void main(String[] args) {
		...
		//String is a class in java. it is come under non primitive data type.
		...
		double d1 = 12.33;
		double d2 = 23.44;
		System.out.println(x+y+d1+d2);//HelloSelenium12.3323C .44
		...
		System.out.println('0'+'a'+'A' + "Hello"+'0');//48+97+65 = 210Hello0
		System.out.println(1*1*10/2+"Hello");//5Hello
